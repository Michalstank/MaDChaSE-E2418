...
## Hardware oppsett
RPI 3B+ og nRF52833 Dk. som utgjør nodene, kommuniserer med hverandre ved hjelp av UART-protokollen. For å muliggjøre kommunikasjonen kobl de sammen ved hjelp av en USB-A til USB-B kabel.
