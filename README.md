...
## Hardware oppsett
RPI 3B+ og nRF52833 Dk. som utgjør nodene, kommuniserer med hverandre ved hjelp av UART-protokollen. For å muliggjøre kommunikasjonen, kobl nRF-en til en av USB-A portene på RPI. For å forsyne noden med strøm kobl RPI til strømforsyning. Dette kreves ikke enda og gjennomføres underveis RPI oppsettet.
